...
**Шаг 2 — min-max нормализация по всему набору:**
```
score = (raw − raw_min) / (raw_max − raw_min)   →  [0.0 … 1.0]
```

Если все ролики имеют одинаковый raw (или набор из одного видео) — всем присваивается `0.5`.
